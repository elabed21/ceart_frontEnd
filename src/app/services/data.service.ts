...
export class DataService {
  ...
  public getCollection(resourceObject: any, routeSuffix = null): Observable<Array<any>> {
  ...
  public getItem(resourceObject: any, routeSuffix = null): Observable<any> {
    return this.sendRequest(
      'get',
   ...
   */
  // @ts-ignore
  public postItem(resource: ApiResourceInterface, routeSuffix: string = null, body: any): Observable<HttpResponse<any>> {
    return this.sendRequest(
      'post',
  ...
  // @ts-ignore
  public postItemFormData(resource: ApiResourceInterface, routeSuffix: string = null, body: any): Observable<HttpResponse<any>> {
    return this.sendRequest(
      'post',
      (routeSuffix !== null) ? resource.getCollectionUri() + routeSuffix : resource.getCollectionUri(),
      new HttpHeaders().set('Content-Type', 'application/form-data'),
      new HttpParams(),
      body
    );
  }
  ...
  public putItemNacc(resource: ApiResourceInterface, routeSuffix = null, body: any): Observable<HttpResponse<any>> {
    return this.sendRequest(
      'put',
      (routeSuffix !== null) ? resource.getItemUri() + routeSuffix : resource.getItemUri(),
      new HttpHeaders().set('Content-Type', 'application/form-data'),
   ...
   * @return Full HTTP response as Observable
   */
  public deleteItem(resource: ApiResourceInterface, routeSuffix = null, body: any ): Observable<HttpResponse<any>> {
    return this.sendRequest(
      'delete',
      (routeSuffix !== null) ? resource.getItemUri() + routeSuffix : resource.getItemUri(),
      new HttpHeaders(),
